 ...
 */
public class AddressFunctionality extends BaseDriver {
...
//             System.out.println("e.getText() = " + e.getText());   // inceleme için geçiş anının fotoğrafı
    ...
    void editAddress()
    {
        ...
        WebElement sonEdit= editAll.get(editAll.size()-1); //  çoklu edit butonlarından son edit olanı aldık
        sonEdit.click();
    ...
    void addAddressAction()  // ACTIONS SINIFI İLE YAPILAN LOCATOR A GEREK KALMIYOR
    {
